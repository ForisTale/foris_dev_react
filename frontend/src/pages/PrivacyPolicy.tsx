...
const PrivacyPolicy = () => {
  return (
    <div className={`${classes.title}`}>
      <h1>Privacy Policy for Foris.dev</h1>

      <p>At Foris.dev, accessible from https://foris.dev/, one of our main priorities is the privacy of our visitors.
        This Privacy Policy document contains types of information that is collected and recorded by Foris.dev and how
        we use it.</p>

      <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to
        contact us. Our Privacy Policy was generated with the help of <a href="https://www.gdprprivacynotice.com/">GDPR
          Privacy Policy Generator</a></p>

      <h2>General Data Protection Regulation (GDPR)</h2>
      <p>We are a Data Controller of your information.</p>

      <p>Foris.dev legal basis for collecting and using the personal information described in this Privacy Policy
        depends on the Personal Information we collect and the specific context in which we collect the information:</p>
      <ul>
        <li>Foris.dev needs to perform a contract with you</li>
        <li>You have given Foris.dev permission to do so</li>
        <li>Processing your personal information is in Foris.dev legitimate interests</li>
        <li>Foris.dev needs to comply with the law</li>
      </ul>

      <p>Foris.dev will retain your personal information only for as long as is necessary for the purposes set out in
      ...
      <p>Foris.dev follows a standard procedure of using log files. These files log visitors when they visit websites.
      ...
      <p>Like any other website, Foris.dev uses 'cookies'. These cookies are used to store information including
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Foris.dev.</p>

      <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on Foris.dev, which are sent directly to users'
      ...
      <p>Note that Foris.dev has no access to or control over these cookies that are used by third-party
        advertisers.</p>

      <h2>Third Party Privacy Policies</h2>

      <p>Foris.dev's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
      ...
      <p>Foris.dev does not knowingly collect any Personal Identifiable Information from children under the age of 13.
      ...
      <p>Our Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
        to the information that they shared and/or collect in Foris.dev. This policy is not applicable to any
